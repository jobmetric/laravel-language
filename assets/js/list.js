        ...
        dt = $('#datatable').on('preXhr.dt', function (e, settings, data) {
            ...
            columns: [
                ...
                // locale
                {
                    name: 'locale',
                    data: function(e) {
                        return `<div class="align-center text-gray-800">${e.locale}</div>`
                    },
                    sortable: true
                },
                // direction
                {
                    name: 'direction',
                    data: function(e) {
                        return `<div class="align-center text-gray-800">${e.direction}</div>`
                    },
                    sortable: true
                },
                // calendar
                ...
                // action
                {
                    data: function(e) {
                        return `<div class="d-flex justify-content-center align-items-center">
                                    <a href="${localize.language.route}/${e.id}/edit" class="btn btn-sm btn-outline btn-outline-dashed bg-light-success btn-color-gray-800">
